  ...
  return (
   ...
   <View  style={{backgroundColor:"#FFF" ,height:"100%"}}>
    <View style={{flexDirection:"row" , justifyContent:"space-evenly",alignItems:"flex-start", backgroundColor:"#96C493",height:60}}>
      ...
      <Text style={styles.title}>  مطبعة المعالي
  </Text>
...
<TouchableOpacity style={{borderWidth:1,height:42,width:"100%",marginLeft:1,justifyContent:"center",alignItems:"center",backgroundColor:"#8C8787"}}>
...
<View style={{height:350,borderStyle:'solid',borderWidth:0.5,margin:9}}>
            ...
            <Text style={{flex:1,backgroundColor:'white',paddingTop:9,textAlign:'center',alignItems:'center',justifyContent:'center',marginLeft:5,fontSize:20,}}>  Big data 
...
<Text style={{color:"#FFFFFF"}}>المزيد</Text>
            ...
            <Text style={{flex:1,backgroundColor:'white',paddingTop:9,textAlign:'center',alignItems:'center',justifyContent:'center',marginLeft:5,fontSize:20,}}>  استيمنت ادرة مشاريع نظم المعلومات 
...
<Text style={{color:"#FFFFFF"}}>المزيد</Text>
    ...
    <View style={{height:350,borderStyle:'solid',borderWidth:0.5,margin:9}}>
            ...
            <Text style={{flex:1,backgroundColor:'white',paddingTop:9,textAlign:'center',alignItems:'center',justifyContent:'center',marginLeft:5,fontSize:20,}}>تلخيص نظم معلومات    
