...
const PaymentView = (props: { onCheckStatus?: any; amount?: any; product?: any }) => { 
                    ...
                    <div class="row">
                        ...
                        <form>
                            <div class="card-holder">
                                    <input type="text" placeholder="اسم حامل البطاقة" id="card-name" class="card-name" />
                                ...
                                <div class="pay-btn">
                                    <input type="submit" class="btn btn-light btn-lg" value="شراء" />
                                </div>
